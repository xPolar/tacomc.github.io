# 🌮 TacoMC Rules
By playing on TacoMC, you agree to the following rules. If you notice that someone is breaking any of the below rules, it is your responsibility to report it to the proper staff. If there are no staff online, contact one on our [Discord](https://discord.gg/9NG9eGyeVh).

### Modified client
* Use of [Badlion](https://client.badlion.net/) client (or any similar clients such as [Lunar](https://www.lunarclient.com/)), [OptiFine](https://www.optifine.net/home), and some mods such as [VoxelMap](https://www.curseforge.com/minecraft/mc-mods/voxelmap), [Xaero's Minimap](https://www.curseforge.com/minecraft/mc-mods/xaeros-minimap), and [JourneyMap](https://www.curseforge.com/minecraft/mc-mods/journeymap) (along with other minimap mods that do not disclose underground blocks) is allowed.
...
* Chat spam of any kind, including command spam and splitting a word in multiple smaller messages, will result in a (temporary) mute. 
...
* Threatening to attack the server, i.e. DDoS attack, is bannable.
...
* We do **not** moderate anything that takes place outside of the bounds of our server. We only moderate actions on the TacoMC server or within the TacoMC Discord server. Anything outside of that is out of our scope of moderation, and you are responsible for moderating yourself.
